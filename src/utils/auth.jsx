...
export const register=async(full_name,email,password,password2)=>{
    try{
        const {data}=await apiInstance.post("user/register/",{'full_name':full_name,'email':email,'password':password,'password2':password2});
...
export const setUser=async()=>{
    ...
    if(isAccesssTokenExpired(access_token)){
...
export const isAccesssTokenExpired=(access_token)=>{
    try{
